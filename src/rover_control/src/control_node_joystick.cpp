...
JoystickNode::JoystickNode() : Node("Joystick"), baseValSent(false)
{

  RCLCPP_INFO(get_logger(), "Joystick Node has been activated");

  ArmJointsPub =
      create_publisher<std_msgs::msg::Float64MultiArray>("Arm_Joints", 10);

  ArmGripperPub =
      create_publisher<std_msgs::msg::Float64MultiArray>("Arm_Gripper", 10);

  ExcavForkPub =
      create_publisher<std_msgs::msg::Float64>("Excavation_Fork", 10);
